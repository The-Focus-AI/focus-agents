---
name: web-researcher
description: Use this agent when the user asks to research a topic on the web, find information about something, or needs comprehensive information gathering. Examples:
